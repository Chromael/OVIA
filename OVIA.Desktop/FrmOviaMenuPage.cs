...
namespace OVIA.Desktop
{
    ...
    public class FrmOviaMenuPage : Form, IOviaWorkspaceScreen, IOviaWorkspaceLayout, IOviaWorkspaceHelpProvider
    {
        ...
        private void BuildCommandBar(Control parent)
        {
            ...
            OviaWorkspaceCommandBar.Populate(commandBar, selectedMenu);
        ...
        private void NavigateByTarget(string target)
        {
            ...
            {
                workspace.NavigateToWorkspaceInfoPage("SETTINGS", "메인  ›  환경설정", "환경설정", "SETTINGS", "OVIA 시스템 동작과 양식/출력 환경 설정을 관리합니다.", "환경설정의 세부 설정은 드롭다운 메뉴에서 선택합니다.");
                return;
            }
